...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'image_publisher' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/mohammad/Video_Publisher_in_ROS_Node/src/image_publisher/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/mohammad/Video_Publisher_in_ROS_Node/devel/lib;/home/mohammad/Video_Publisher_in_ROS_Node/devel/lib;/opt/ros/noetic/lib)
